...
const Navbar = () => {
    ...
    return (
        <>
            ...
            {
                isDwear &&
                <div className={`z-50 absolute w-72 h-full rounded-lg top-0 bottom-0 transition-all bg-gray-900 ${isDwear ? 'right-0' : '-right-80'}`}>
                        ...
                        {user?.photoURL ?
                            <div>
                                ...
                                <div className='cursor-pointer flex justify-end items-center my-5 bg-gray-800 active:bg-gray-800 transition-all py-2 text-gray-50'>
                                    <span className="font-semibold capitalize mr-4">Dashboard</span>
                            ...
                            <div>
                                <div className='cursor-pointer flex  justify-between items-center mt-5 px-4'>
                                    ...
                                    <span className='text-xl mr-2 text-white font-bold capitalize'>Jhon Doe</span>
                                </div>
                                <div className='cursor-pointer flex justify-end items-center my-5 bg-gray-800 active:bg-gray-800 transition-all py-2 text-gray-50'>
                                    <span className="font-semibold capitalize mr-4">Dashboard</span>
                                    <MdDashboard className='w-6 h-6 mr-4'></MdDashboard>
